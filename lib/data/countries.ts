...
//
// Catálogo estático de países con su código ISO-3166-1 alpha-2 y su código
// de marcación telefónica. Se usa para el selector de país en cualquier
// campo de teléfono (PhoneField) y para poder derivar la bandera del país
// sin depender de una librería ni de imágenes — ver lib/utils/phone.ts.
//
// Por qué código de país es obligatorio en el teléfono: los reportes
// diarios (ver docs/decisions.md pendiente) se envían a la medianoche
// LOCAL del negocio, y la única forma confiable de saber en qué zona
// horaria está un negocio sin pedirle un dato aparte es a partir del
// código de país de su teléfono.
