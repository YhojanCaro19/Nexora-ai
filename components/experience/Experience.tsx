        ...
        <ExperienceProvider>
          ...
          <div className="relative min-h-screen w-full bg-[#08090D]">
            ...
            <div className="relative w-full overflow-hidden">
              ...
              {/* Mobile/tablet: SIN intro. Pedido explícito del usuario —
                  "no quiero que se vea nada de lo viejo": se quitó la intro
                  2D de texto ("AVENTHRA" / "Tu empleado virtual") y el
                  wordmark 3D que subía y se asentaba sobre el navbar
                  (MobileSceneContainer / MobileWordmarkScene). Queda solo el
