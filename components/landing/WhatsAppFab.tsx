...
export function WhatsAppFab() {
  ...
  return (
    ...
    >
      ...
      {/* Texto que se despliega en hover/focus. El truco grid 0fr→1fr
          anima el ancho de forma suave sin necesitar un valor fijo. */}
      <span className="grid grid-cols-[0fr] transition-[grid-template-columns] duration-300 ease-out group-hover:grid-cols-[1fr] group-focus-visible:grid-cols-[1fr]">
        <span className="overflow-hidden">
          <span className="block whitespace-nowrap pr-1 pl-2.5 font-light">
            {t('cta')}
          </span>
        </span>
      </span>
