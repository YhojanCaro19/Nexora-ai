...
// Mismo componente que admin/perfil/avatar-editor.tsx (copia local, no
// import cruzado): cada uno apunta a sus propias actions ("./actions"
// resuelve distinto en cada carpeta — admin escribe en business_members,
// esto escribe en platform_admins).
