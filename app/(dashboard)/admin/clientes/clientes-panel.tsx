  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-center" style={{ color: 'var(--nexora-ink-dim)' }}>
        ...
        {/* Una sola tabla para todos los tamaños — el componente Table
            (components/ui/table.tsx) ya envuelve en un div con overflow-x-auto,
            así que en una pantalla angosta la fila completa se puede correr
            con el dedo en vez de reacomodarse. */}
        <Table>
          <TableHeader>
            <TableRow>
